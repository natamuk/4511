...
(1, 'Chai Wan Community Clinic', 'Hong Kong Chai Wan', 'General practice, vaccination, chronic disease follow-up', 1, 1, '2026-04-05 00:01:59', '2026-04-05 00:01:59'),
...
INSERT INTO `doctor` (`id`, `username`, `password`, `real_name`, `gender`, `phone`, `email`, `title`, `department_id`, `introduction`, `avatar`, `status`, `register_fee`, `create_time`, `update_time`) VALUES
(1, 'doctor01', '123456', 'Dr. Smith', 1, '13900000001', 'smith@hospital.com', 'Chief Physician', 1, 'Experienced internal medicine doctor', NULL, 1, 20.00, '2026-04-02 23:04:55', '2026-04-02 23:04:55'),
(2, 'doctor02', '123456', 'Dr. Johnson', 1, '13900000002', 'johnson@hospital.com', 'Associate Chief Physician', 2, 'Experienced surgery doctor', NULL, 1, 25.00, '2026-04-02 23:04:55', '2026-04-02 23:04:55'),
(3, 'doctor03', '123456', 'Dr. Williams', 2, '13900000003', 'williams@hospital.com', 'Attending Physician', 3, 'Pediatric specialist', NULL, 1, 18.00, '2026-04-02 23:04:55', '2026-04-02 23:04:55'),
(4, 'doctor04', '123456', 'Dr. Brown', 2, '13900000004', 'brown@hospital.com', 'Chief Physician', 4, 'Gynecology specialist', NULL, 1, 22.00, '2026-04-02 23:04:55', '2026-04-02 23:04:55'),
(5, 'doctor05', '123456', 'Dr. Davis', 1, '13900000005', 'davis@hospital.com', 'Attending Physician', 5, 'Dermatology specialist', NULL, 1, 15.00, '2026-04-02 23:04:55', '2026-04-02 23:04:55'),
(6, 'doctor06', '123456', 'Dr. Miller', 1, '13900000006', 'miller@hospital.com', 'Chief Physician', 6, 'ENT specialist', NULL, 1, 20.00, '2026-04-02 23:04:55', '2026-04-02 23:04:55');
...
(1, 'patient01', '123456', 'Alice', 2, '13700000001', 'alice@example.com', 'P100000000001', '1995-03-10', 'New York', NULL, 200.00, 1, '2026-04-02 23:04:55', '2026-04-03 00:57:59'),
...
(2, 1, NULL, 1, 'Q001', 'waiting', NULL, '2026-04-06 19:20:12', '2026-04-06 19:20:12');
...
INSERT INTO `registration` (`id`, `reg_no`, `patient_id`, `doctor_id`, `department_id`, `schedule_id`, `reg_date`, `queue_no`, `fee`, `status`, `cancel_time`, `call_time`, `create_time`, `update_time`) VALUES
(1, 'REG202603310001', 1, 1, 1, 1, '2026-03-31', 1, 20.00, 2, '2026-04-06 19:09:35', NULL, '2026-04-02 23:04:55', '2026-04-06 19:09:35'),
(2, 'REG202603310002', 2, 1, 1, 1, '2026-03-31', 2, 20.00, 3, NULL, '2026-03-31 21:56:15', '2026-04-02 23:04:55', '2026-04-02 23:04:55'),
(3, 'REG202603310003', 3, 2, 2, 2, '2026-03-31', 1, 25.00, 4, NULL, '2026-03-31 21:56:15', '2026-04-02 23:04:55', '2026-04-02 23:04:55'),
(4, 'REG202603310004', 4, 3, 3, 3, '2026-03-31', 1, 18.00, 5, NULL, '2026-03-31 21:56:15', '2026-04-02 23:04:55', '2026-04-02 23:04:55'),
(5, 'REG202603310005', 5, 4, 4, 4, '2026-03-31', 1, 22.00, 2, '2026-03-31 21:56:15', NULL, '2026-04-02 23:04:55', '2026-04-02 23:04:55');
...
(5, 5, 5, 1, '2026-03-31', 2, 3, 12, 0, 1, '2026-04-02 23:04:55', '2026-04-05 19:46:54'),
(6, 6, 6, 1, '2026-03-31', 2, 3, 16, 4, 1, '2026-04-02 23:04:55', '2026-04-05 19:46:54');
...
--
ALTER TABLE `doctor`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Doctor ID', AUTO_INCREMENT=7;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `doctor_issue`
--
ALTER TABLE `doctor_issue`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Issue ID';
...
--
ALTER TABLE `queue`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Queue ID', AUTO_INCREMENT=3;
...
--
ALTER TABLE `registration`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Registration ID', AUTO_INCREMENT=6;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `schedule`
--
ALTER TABLE `schedule`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Schedule ID', AUTO_INCREMENT=7;
