...
public class AdminSettingsServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (isBlank(maxActiveBookings)) maxActiveBookings = "3";
        if (isBlank(cancelDeadlineHours)) cancelDeadlineHours = "24";
        if (isBlank(sameDayQueueEnabled)) sameDayQueueEnabled = "0";
        if (isBlank(bookingApprovalRequired)) bookingApprovalRequired = "0";
