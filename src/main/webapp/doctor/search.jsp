...
<html>
<head>
    <meta charset="UTF-8"><title>Doctor - Patient Search</title>
...
<div class="flex h-screen overflow-hidden relative">
    <!-- 左側導航欄（同前，active 為 Patient Search） -->
    <div class="w-80 glass shadow-2xl flex flex-col border-r border-white/50 z-40 fixed h-full">
        ...
        <div class="p-6 flex-1 flex flex-col overflow-y-auto">
            ...
            <nav class="flex flex-col gap-1">
                ...
                <a href="<%= ctx %>/doctor/search" class="nav-item flex items-center gap-3 px-5 py-3 rounded-2xl active"><i class="fa-solid fa-magnifying-glass w-5"></i><span>Patient Search</span></a>
    ...
    <div class="flex-1 flex flex-col min-w-0 ml-80">
        <div class="flex-1 overflow-auto p-4 md:p-8">
            <div class="max-w-6xl mx-auto">
                <h2 class="text-2xl font-bold mb-6">Patient Lookup</h2>
                <div class="card">
                    <form method="get" action="<%= ctx %>/doctor/search" class="flex gap-2 mb-6">
                        <input type="text" name="keyword" value="<%= keyword %>" placeholder="Enter name or phone" class="flex-1">
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr><td><%= r.get("name") %></td><td><%= r.get("phone") %></td></tr>
                                    <% } %>
                                    <% if (searchResults.isEmpty()) { %><tr><td colspan="2" class="text-center py-4">No patients found.</td></tr><% } %>
                                </tbody>
                            </table>
                        </div>
                    <% } %>
