<%-- 
    Document   : quota
    Created on : 2026年4月29日, 02:18:07
    Author     : 123
--%>
...
<head>
    ...
    <title>Services & Quota - CCHC Admin</title>
    ...
    <style>
        ...
        *{box-sizing:border-box}body{font-family:'Noto Sans TC',sans-serif;background:linear-gradient(135deg,#f0f9ff 0%,#e0e7ff 100%)}
        ...
        .badge-success{background:#dcfce7;color:#166534}.badge-danger{background:#fee2e2;color:#b91c1c}.badge-info{background:#dbeafe;color:#1d4ed8}
    </style>
</head>
...
<div class="flex h-screen overflow-hidden">
    <aside class="w-80 glass shadow-2xl flex flex-col border-r border-white/50 fixed md:relative h-full z-40">
        ...
        <div class="p-6 flex-1 flex flex-col overflow-y-auto">
            ...
            <nav class="space-y-1">
                ...
                <a href="${pageContext.request.contextPath}/admin/quota.jsp" class="nav-item active"><i class="fa-solid fa-server w-5"></i><span>Services & Quota</span></a>
    ...
    <div class="flex-1 flex flex-col min-w-0">
        <header class="glass border-b px-8 py-4 flex justify-between items-center">
            <h2 class="text-2xl font-semibold">Services & Quota</h2><div class="flex items-center gap-3"><span id="current-date" class="text-sm text-gray-500"></span></div>
        </header>
        <div class="flex-1 overflow-auto p-4 md:p-8">
            <!-- 原 quota-contents.jsp 内容开始 -->
