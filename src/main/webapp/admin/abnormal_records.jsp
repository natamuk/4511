            ...
            <div class="space-y-8">
                ...
                <div class="glass p-6 rounded-3xl">
                    ...
                    <c:if test="${not empty repeatNoShow}">
                        <table class="w-full text-left border-collapse"><thead class="bg-gray-100"><tr><th class="p-3">Patient</th><th class="p-3">Phone</th><th class="p-3">No-show Count</th></table></thead>
