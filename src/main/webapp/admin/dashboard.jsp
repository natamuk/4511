<%-- 
    Document   : dashboard
    Created on : 2026年4月26日, 15:31:20
    Author     : 123
--%>
...
<%@ page import="com.mycompany.system.db.*" %>
<%@ page import="com.mycompany.system.bean.*" %>
...
<%
    ...
    // Load data (replace with your actual DAO methods)
    ...
    if (request.getAttribute("appointments") != null) {
        appointments = (List<Map<String, Object>>) request.getAttribute("appointments");
    }
    if (request.getAttribute("queueList") != null) {
        queueList = (List<Map<String, Object>>) request.getAttribute("queueList");
    }
    if (request.getAttribute("quota") != null) {
        quota = (List<Map<String, Object>>) request.getAttribute("quota");
    }
...
<head>
    ...
    <title>Dashboard - CCHC Admin Console</title>
    ...
    <style>
        * { box-sizing: border-box; }
        body { font-family: 'Inter', sans-serif; background: linear-gradient(135deg, #f0f9ff 0%, #e0e7ff 100%); }
...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-80 glass shadow-2xl flex flex-col border-r border-white/50 fixed md:relative h-full z-40">
        ...
        <div class="p-6 flex-1 flex flex-col overflow-y-auto">
            <div class="flex items-center gap-4 p-4 glass rounded-3xl mb-8">
                <img src="https://picsum.photos/200/200?random=99" class="w-14 h-14 rounded-2xl ring-4 ring-white object-cover" alt="avatar">
                <div>
            ...
            <nav class="space-y-1">
                <a href="${pageContext.request.contextPath}/admin/dashboard.jsp" class="nav-item active">
                    <i class="fa-solid fa-chart-pie w-5"></i><span>Dashboard</span>
                </a>
                <a href="${pageContext.request.contextPath}/admin/users.jsp" class="nav-item">
                    <i class="fa-solid fa-users w-5"></i><span>User Management</span>
                </a>
                <a href="${pageContext.request.contextPath}/admin/appointments.jsp" class="nav-item">
                    <i class="fa-solid fa-calendar-check w-5"></i><span>Appointments</span>
                </a>
                <a href="${pageContext.request.contextPath}/admin/queue.jsp" class="nav-item">
                    <i class="fa-solid fa-list-ol w-5"></i><span>Queue</span>
                </a>
                <a href="${pageContext.request.contextPath}/admin/quota.jsp" class="nav-item">
                    <i class="fa-solid fa-server w-5"></i><span>Services & Quota</span>
                </a>
                <a href="${pageContext.request.contextPath}/admin/reports.jsp" class="nav-item">
                    <i class="fa-solid fa-chart-bar w-5"></i><span>Reports</span>
                </a>
                <a href="${pageContext.request.contextPath}/admin/logs.jsp" class="nav-item">
                    <i class="fa-solid fa-clipboard-list w-5"></i><span>Audit Logs</span>
                </a>
                <a href="${pageContext.request.contextPath}/admin/notifications.jsp" class="nav-item">
                    <i class="fa-solid fa-bell w-5"></i><span>Notifications</span>
                </a>
                <a href="${pageContext.request.contextPath}/admin/settings.jsp" class="nav-item">
                    <i class="fa-solid fa-sliders w-5"></i><span>Settings</span>
                </a>
                <a href="${pageContext.request.contextPath}/admin/csv.jsp" class="nav-item">
                    <i class="fa-solid fa-file-csv w-5"></i><span>CSV Import/Export</span>
                </a>
                <a href="${pageContext.request.contextPath}/admin/profile.jsp" class="nav-item">
    ...
    <div class="flex-1 flex flex-col min-w-0">
        ...
        <div class="flex-1 overflow-auto p-4 md:p-8">
            <jsp:include page="/admin/contents/dashboard-contents.jsp" />
        </div>
    </div>
</div>
