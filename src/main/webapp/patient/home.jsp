...
<html lang="en">
    <head>
        ...
        <style>
            ...
            * { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            #main-content { opacity: 0; transform: translateY(10px); transition: opacity 0.2s ease, transform 0.2s ease; }
    ...
    <body class="min-h-screen">
            ...
            <div id="sidebar" class="w-72 glass shadow-2xl flex flex-col border-r border-white/50 z-40">
                ...
                <div class="p-6 flex-1 flex flex-col">
                    ...
                    <div class="flex items-center gap-4 p-4 glass rounded-3xl mb-8">
                        <img id="sidebar-avatar" class="w-14 h-14 rounded-2xl ring-4 ring-white object-cover" src="<%= avatar %>" alt="avatar">
                        <div>
        ...
        <script>
            ...
            // 将 request 中的属性转换为全局 JavaScript 变量，供异步加载的 JSP 使用
            window.PATIENT_DATA = {
            ...
            window.queueData = <%= request.getAttribute("queueJson") != null ? request.getAttribute("queueJson") : "[]" %>;
            ...
            window.patientProfile = {
                realName: '<%= (profile != null && profile.get("realName") != null) ? profile.get("realName") : "Patient" %>',
                avatar: '<%= (profile != null && profile.get("avatar") != null) ? profile.get("avatar") : "" %>'
            };
            ...
            function loadPage(page) {
                ...
                const titles = {
                    home: "Home", book: "Book Appointment", calendar: "Appointment Calendar",
                    my: "My Appointments", queue: "Join Queue", notifications: "Notifications",
                    profile: "Profile", favorites: "Favorite Clinics", record: "Medical History"
                };
                const subs = {
                    home: "Clinic overview for today", book: "Choose clinic & time slot",
                    calendar: "View schedule", my: "Manage bookings", queue: "Walk-in waiting",
                    notifications: "Alerts", profile: "Account", favorites: "Saved", record: "History"
                };
            ...
            function logout() {
                Swal.fire({
                    ...
                    if (r.isConfirmed) window.location.href = contextPath + "/login.jsp";
                });
            }
